...
mkdir -p ${WORKDIR}
cd ${WORKDIR} || exit 1
root -q -b -l /shome/peruzzi/CMSSW_5_3_10_patch2/src/DiLeptonAnalysis/NTupleProducer/test/ASAnalysis/diphoton/prepare_matchingfile_forstep2.C+O\(\"/scratch/peruzzi/matchingfile_data_14may.root\",\"/scratch/peruzzi/Photon-Run2011AB-21Jun2013-v1-AOD-EXTRA-14may.root\",$1\)
cd ${WORKDIR} || exit 1
